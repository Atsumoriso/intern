        ...
        <ul class="nav navbar-right top-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="<?=SITE_URL?>/profile/index"><i class="fa fa-fw fa-user"></i> Profile</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?=SITE_URL?>/admin/logout"><i class="fa fa-fw fa-power-off"></i><input type="submit" value="Logout"></a>
                    </li>
                    </form>
                </ul>
            </li>
...
<!--                </li>-->
                <li>
                    ...
                    <ul id="demo" class="collapse">
                        <li>
                            <a href="<?=SITE_URL?>/dashboard/import">Import</a>
                        </li>
                        <li>
                            <a href="<?=SITE_URL?>/dashboard/list">List</a>
                        </li>
<!--                        <li>-->
<!--                            <a href="--><?//=SITE_URL?><!--/dashboard/edit">Edit</a>-->
<!--                        </li>-->
                    </ul>
                </li>
<!--                <li class="active">-->
