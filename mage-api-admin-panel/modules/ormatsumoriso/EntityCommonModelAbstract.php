               ...
               FindInterface
{
     ...
     * @inheritdoc
     *
     * @return array   -   array in the form "'count' => 10 ".
     */
    public function findAllAndCount()
    {
        $query = '
            SELECT count('
            . $this->getIdIdentifier() . ') count
            FROM '
            . $this->getTableName();
    ...
    /**
     * Checks function names (getters and setters), and compares with table columns names. If such property exists,
